...
public class R2DBCQueryParser {
    /**
     * Parses R2DBC query to replace all ? to YQL parameters.
     *
     * @param builder Ydb query builder
     * @throws R2dbcBadGrammarException if query contains mix of query types
     */
    public static void buildQuery(YdbQueryBuilder builder) throws R2dbcBadGrammarException {
        int fragmentStart = 0;
